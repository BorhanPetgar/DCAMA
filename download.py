...
url = 'https://drive.google.com/uc?id=1Fn-cUESMMF1pQy8Xff-vPQvXJdZoUlP3'
output = 'fss.zip'
...
# folder_id = '12eoVUGtAtuMHYLeyuyi2t1O8Ljxly4cI'
# output_folder = "sent_dataset"  # Where to save the folder contents
